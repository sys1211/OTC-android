...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected boolean mHighlightScrollOnly = false;
    ...
    public void toggleScaleStep(int index){
        if (mChartTouchListener instanceof BarLineChartTouchListener)
            ((BarLineChartTouchListener) mChartTouchListener).toggleScaleStep(index);

    }

    public int getLastScaleIndex() {
        if (mChartTouchListener instanceof BarLineChartTouchListener)
            return ((BarLineChartTouchListener) mChartTouchListener).getLastScaleIndex();
        return 0;
    }
    ...
    public int getScaleXCount() {
        return mScaleXCount;
    }

    public void setScaleXCount(int mScaleXCount) {
        this.mScaleXCount = mScaleXCount;
    }
    ...
    public boolean isHighlightScrollOnly() {
        return mHighlightScrollOnly;
    }

    public void setHighlightScrollOnly(boolean enabled) {
        this.mHighlightScrollOnly = enabled;
    }
