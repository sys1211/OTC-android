...
public class CandleStickChartRenderer extends LineScatterCandleRadarRenderer {
    ...
    protected void drawDataSet(Canvas c, ICandleDataSet dataSet) {
        ...
        CandleEntry highEntry = null;
        CandleEntry lowEntry = null;
        ...
        drawEdgeMark(highEntry, lowEntry, c,dataSet);
    }

    protected void drawEdgeMark(CandleEntry highEntry, CandleEntry lowEntry, Canvas c,ICandleDataSet dataSet) {
