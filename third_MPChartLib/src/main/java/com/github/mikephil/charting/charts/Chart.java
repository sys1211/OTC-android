...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    private ChartLoadingAnimator mLoadingAnimator;

    public void setLoadingAnimator(ChartLoadingAnimator animator) {
        this.mLoadingAnimator = animator;
        if (mLoadingAnimator != null && mLoadingAnimator.getLoadingDrawable() != null) {
            mLoadingAnimator.getLoadingDrawable().setCallback(this);
        }
    }
     ...
     * yangchuanzhe
     *
     * @param mViewPortHandler
     */
    public void setViewPortHandler(ViewPortHandler mViewPortHandler) {
    ...
    public void showEmpty(String text) {
        if (mLoadingAnimator != null && mLoadingAnimator.getLoadingDrawable() != null) {
            mLoadingAnimator.getLoadingDrawable().setVisible(false, false);
        }
        this.setNoDataText(text);
        invalidate();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isEmpty()) {
            ...
            if (hasText) {
                ...
                if (mLoadingAnimator != null && mLoadingAnimator.getLoadingDrawable() != null) {
                    MPPointF c = getCenter();
                    mLoadingAnimator.getLoadingDrawable().setBounds((int) c.x - 20, (int) c.y - 20, (int) c.x + 20, (int) c.y + 20);
                    mLoadingAnimator.getLoadingDrawable().draw(canvas);
                    mLoadingAnimator.getLoadingDrawable().invalidateSelf();
                    mLoadingAnimator.startLoading();
                }
            }
    ...
    protected boolean verifyDrawable(Drawable who) {
        if (mLoadingAnimator != null && mLoadingAnimator.getLoadingDrawable() == who) {
            return true;
        }
    ...
    protected void drawDescription(Canvas c) {
        ...
        if (mDescription != null && mDescription.isEnabled()) {
            ...
            c.drawText(mDescription.getText(), 0, mDescription.getText().length(), x, y, mDescPaint);
        }
    }
