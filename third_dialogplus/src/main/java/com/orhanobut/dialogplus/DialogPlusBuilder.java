...
public class DialogPlusBuilder {
    ...
    private Animation inAnimationDynamic;
    private Animation outAnimationDynamic;
    ...
    /**
     * Customize the in animation by passing an animation
     */
    public DialogPlusBuilder setInAnimationDynamic(Animation inAnimationDynamic) {
        this.inAnimationDynamic = inAnimationDynamic;
        return this;
    }

    /**
     * Customize the out animation by passing an animation
     */
    public DialogPlusBuilder setOutAnimationDynamic(Animation outAnimationDynamic) {
        this.outAnimationDynamic = outAnimationDynamic;
        return this;
    }
    ...
    public Animation getInAnimation() {
        if (inAnimationDynamic != null) {
            return inAnimationDynamic;
        }
    ...
    public Animation getOutAnimation() {
        if (outAnimationDynamic != null) {
            return outAnimationDynamic;
        }
