 ...
 */
package com.ubfx.library.quickadapter;
...
public class BaseAdapterHelper {
     ...
     * Will set the text of a TextView.
     * @param viewId The view id.
     * @param resId  The text res id to put in the text view.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setText(int viewId, @StringRes int resId) {
        TextView view = retrieveView(viewId);
        view.setText(resId);
        return this;
    }
    ...
    /**
     * Will set the image of an ImageView from a url.
     * @param viewId     The view id.
     * @param key The image url.
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper loadImage(int viewId, String key) {
        ImageView view = retrieveView(viewId);
        ImageLoadUtils.loadImage(key,view);
        return this;
    }

    public BaseAdapterHelper loadAvatar(int viewId, String key) {
        ImageView view = retrieveView(viewId);
        ImageLoadUtils.loadAvatar(key,view);
        return this;
    }
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTextColor(int viewId,@ColorInt int textColor) {
        TextView view = retrieveView(viewId);
     ...
     * @return The BaseAdapterHelper for chaining.
     */
    public BaseAdapterHelper setTextColorRes(int viewId,@ColorRes int textColorRes) {
        TextView view = retrieveView(viewId);
