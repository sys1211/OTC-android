...
import com.ubfx.library.loading.animation.AnimationUtils;
import com.ubfx.library.loading.animation.FloatProperty;
import com.ubfx.library.loading.animation.IntProperty;
...
public abstract class Sprite extends Drawable implements
        ...
        , Animatable
        , Drawable.Callback, ChartLoadingAnimator {
    ...
    public void setPercent(@FloatRange(from = 0.0f, to = 1.0f) float percent) {
