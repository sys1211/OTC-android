package com.ubfx.library.view.scroller;
...
public class BubbleScroller extends View {
    ...
    private static final float BUMPER_RADIUS = 50F;
    ...
    private void init(Context c, @Nullable AttributeSet attrs) {
        ...
        mDebugPaint = createDebugPaint(Color.GREEN);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            width = (int) (BUMPER_RADIUS * 2);
        }

        if (heightMode == MeasureSpec.EXACTLY) {
            height = heightSize;
        } else {
            height = (int) (mSectionCount * mTextSize);
        }
...
//            int rectTop = (int) (bottom - top - mSectionCount * mTextSize) / 2 + getPaddingTop();
//            int rectBottom = bottom - top - (int) (bottom - top - mSectionCount * mTextSize) / 2 - getPaddingBottom();

            mDrawableRect.left = getPaddingLeft();
            mDrawableRect.top = getPaddingTop() + mTextSize/2 ;
//            mDrawableRect.top = rectTop;
            mDrawableRect.right = right - left - getPaddingRight();
            mDrawableRect.bottom = bottom - top - getPaddingBottom() - mTextSize/2;
//            mDrawableRect.bottom = rectBottom;
